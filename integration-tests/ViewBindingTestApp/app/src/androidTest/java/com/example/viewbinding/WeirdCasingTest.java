...
public final class WeirdCasingTest {
    ...
    @Test public void inflate() {
        WeirdCasingBinding binding = WeirdCasingBinding.inflate(inflater);
        assertTrue(binding.simple instanceof Simple);
        assertTrue(binding.nested instanceof Simple.lowercase.UPPERCASE.camelCase);
    }
}
